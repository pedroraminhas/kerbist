...
public class RequestTicketIT extends BaseIT {
	...
	public void testValidRequest() throws Exception {
		...
		SessionKeyAndTicketView result = client.requestTicket(clientName, serverName, nonce, duration);
		...
		/* assertEquals(nonce, sessionKey.getNonce); */
		/* assertNotNull(session.getKeyXY()) */
